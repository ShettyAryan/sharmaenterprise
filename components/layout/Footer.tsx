      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-20 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-5">
            <h4 className="font-sans text-[10px] font-bold tracking-[0.2em] uppercase text-white/40">Services</h4>
            <ul className="space-y-3">
              {["Investment Portfolio", "Insurance Policies", "Wealth Basket", "Targeted Investment", "Tax Optimisation"].map((s) => (
                <li key={s}>
          ...
          {/* Products */}
          <div className="space-y-5">
            <h4 className="font-sans text-[10px] font-bold tracking-[0.2em] uppercase text-white/40">Products</h4>
            <ul className="space-y-3">
              {["Mutual Fund", "Insurance", "PMS", "Direct Equity", "Fixed Deposit", "Bonds", "Smallcase", "LiquiLoans"].map((p) => (
                <li key={p}>
                  <Link href="#" className="font-sans text-sm text-white/60 hover:text-white transition-colors">
                    {p}
                  </Link>
          ...
          {/* Contact */}
          <div className="space-y-5">
            <h4 className="font-sans text-[10px] font-bold tracking-[0.2em] uppercase text-white/40">Get in Touch</h4>
            <div className="space-y-4">
              <div>
                <div className="font-sans text-white/40 text-[10px] uppercase tracking-widest mb-1">Surat Office</div>
                <p className="font-sans text-sm text-white/60 leading-relaxed">
                  Ring Road, Vesu,<br />Surat – 395 007, Gujarat
                </p>
              </div>
              <div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            {["Privacy Policy", "Terms of Service", "Disclaimer"].map((item) => (
              <Link key={item} href="#" className="font-sans text-white/30 hover:text-white/60 text-xs transition-colors">
                {item}
              </Link>
            ))}
          </div>
